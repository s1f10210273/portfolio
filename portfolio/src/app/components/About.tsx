...
export default function About() {
  return (
    // <div className="m-5 p-4 bg-white rounded-lg">
    //   <h1 className="font-semibold text-3xl">Oshikubo Shuei</h1>

    // </div>
<div className="m-5 p-4 bg-white rounded-lg overflow-hidden shadow-md">
<h1 className="text-5xl text-center font-bold m-5">About Me</h1>
  <div className="flex flex-col justify-center items-center md:flex-row">
  <div className="m-2 flex flex-col items-center justify-center bg-white p-8 rounded-lg md:w-1/2">

    <div className="flex flex-col items-center mb-5">
    <h2 className="text-xl text-center mb-2">名前: 押久保秀英</h2>
        <h2 className="text-xl text-center mb-2">出身: 東京都江戸川区</h2>
        <h2 className="text-xl text-center mb-2">生年月日: 2002年8月11日</h2>
        <h2 className="text-xl text-center mb-2">趣味: ギター・プログラミング・写真</h2>
    </div>
